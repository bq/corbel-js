        ...
        describe('because of unauthorized', function() {
          ...
          it('tries to refresh token', function(done) {
            ...
            service.request({
              ...
              expect(spyRefresh.calledTwice).to.be.equal(true);
              expect(stubToken.calledTwice).to.be.equal(true);
              expect(spyTokenRefresh.calledTwice).to.be.equal(true);
              done();
            });
            ...
            it('tries to refresh token but fails as credentials are not provided', function(done) {
              ...
              service.request({
                ...
                .catch(function(response) {
                  ...
                  expect(spyConfigSet.callCount).to.be.equal(0);
