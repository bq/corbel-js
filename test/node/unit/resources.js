...
var TEST_ENDPOINT = 'https://resources-qa.bqws.io/v1.0/domain-example/',
  ...
  URL_COLLECTION_DECODED = TEST_ENDPOINT + 'resource/resource:entity?api:query=' + DEFAULT_QUERY_OBJECT_STRING + '&api:search={"text":"test"}&api:distinct={"text":"test"}&api:sort={"field1":"asc"}&api:page=1&api:pageSize=5',
...
describe('corbel resources module', function() {
  ...
  it('generate resource query correctly', function() {
    var urlDecoded = TEST_ENDPOINT + 'resource/resource:entity?api:query=' + DEFAULT_QUERY_OBJECT_STRING +
      '&api:search={"text":"test"}&api:distinct={"text":"test"}&api:sort={"field1":"asc"}&api:page=0&api:pageSize=0';
    var requestParams = {
      query: DEFAULT_QUERY_OBJECT,
      search: {
        text: 'test'
