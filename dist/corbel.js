(function(root, factory) {
    ...
    (function() {
        ...
        var BorrowBuilder = corbel.Borrow.BorrowBuilder = corbel.Services.BaseServices.inherit({
             ...
             * @param {number} loanableResource.availableUses   Amount of uses that the resource is available
             * @param {number} loanableResource.availableLoans  Amount of concurrent loans are available for the resource
             * @param {timestamp} loanableResource.expire       Expire date
             * @param {timestamp} loanableResource.start        Start date
             * @param {String} loanableResource.asset           Asigned to the resource
             *
            ...
            applyFor: function(userId) {
                console.log('borrowInterface.resource.applyFor');
                return this.request({
            ...
            getLentOf: function(userId) {
                console.log('borrowInterface.resource.getLentOf');
                return this.request({
                    url: this._buildUri(this.uri, this.id, '/loan/' + userId),
                    method: corbel.request.method.GET
                });
            ...
            returnLoanOf: function(userId) {
                console.log('borrowInterface.resource.returnLoanOf');
                return this.request({
                    url: this._buildUri(this.uri, this.id, '/loan/' + userId),
                    method: corbel.request.method.DELETE
                });
            ...
            renewFor: function(userId) {
                console.log('borrowInterface.resource.renewFor');
                return this.request({
            ...
            reserveFor: function(userId) {
                console.log('borrowInterface.resource.reserveFor');
                return this.request({
            ...
            cancelReservationFor: function(userId) {
                console.log('borrowInterface.resource.cancelReservationFor');
                return this.request({
                    url: this._buildUri(this.uri, this.id, '/reservation/' + userId),
                    method: corbel.request.method.DELETE
                });
            ...
            getHistoryOf: function(userId) {
                console.log('borrowInterface.resource.getHistoryOf');
                return this.request({
                    url: this._buildUri(this.uri, this.id, '/history/' + userId),
                    method: corbel.request.method.GET
                });
            },
            /**
            ...
            getMyHistory: function() {
                ...
                return this.request({
                    url: this._buildUri(this.uri, this.id, '/history/me'),
                    method: corbel.request.method.GET
                });
            },
            /**
            ...
            getFullHistory: function(params) {
                ...
                return this.request({
                    url: this._buildUri(this.uri, this.id, '/history/'),
                    method: corbel.request.method.GET,
                    query: params ? corbel.utils.serializeParams(params) : null
                });
            },
    ...
    (function() {
        ...
        var UserBuilder = corbel.Borrow.UserBuilder = corbel.Services.BaseServices.inherit({
            ...
            getAllReservations: function() {
                console.log('borrowInterface.user.getAllReservations');
            ...
            getAllLoans: function() {
                console.log('borrowInterface.user.getAllLoans');
