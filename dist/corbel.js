(function(root, factory) {
    ...
    var BaseServices = (function() {
        ...
        function buildDefaults(destiny, defaults) {
        ...
        var BaseServices = corbel.Object.inherit({ //instance props
            ...
            request: function(args) {
                ...
                var isJson = function(item) {
                    return typeof(item) === 'string' && item.indexOf('{') === 0;
                };
            ...
            _buildParams: function(args) {
                ...
                var params = buildDefaults(args, defaults);
                ...
                return pick(params, ['url', 'dataType', 'contentType', 'method', 'headers', 'data', 'dataFilter', 'caller']);
            }
        });
